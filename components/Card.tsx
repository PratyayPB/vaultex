  ...
  return (
    <div className="bg-white p-2 m-4 w-min rounded-2xl ">
      <Link href={file.url} target="_blank" className="file-card ">
        <div className="flex justify-between px-2 w-50 h-30">
          <Thumbnail
            type={file.type}
            extension={file.extension}
            url={file.url}
            className="!size-25 bg-gray-100 flex items-center justify-center rounded-full"
            imageClassName="!size-18"
          />
          <div className="flex flex-col items-end justify-start gap-6 pt-4">
            <ActionDropdown file={file} />
            <p className="body-1 caption line-clamp-1 ">
